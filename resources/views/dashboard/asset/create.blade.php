            ...
            <div class="row justify-content-center form-bg-image">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                        <h1 class="h3 mb-4">Tambah Data Asset</h1>
                        <form action="{{ route('asset.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="judul asset" name="title" id="title" required>
                                </div>  
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" placeholder="detail..." id="desc" name="desc" rows="4"></textarea>
                            </div>
