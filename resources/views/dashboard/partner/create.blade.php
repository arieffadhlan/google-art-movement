            ...
            <div class="row justify-content-center form-bg-image">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                        <h1 class="h3 mb-4">Tambah Data Partner</h1>
                        <form action="{{ route('partner.store') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" placeholder="lokasi" class="form-control" name="location" id="location" required>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" placeholder="link logo" class="form-control" name="logo" id="image" required>
                            </div>
