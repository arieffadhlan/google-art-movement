<x-app-layout title="Asset">
    <div class="container asset">
        ...
        <div class="asset-header d-flex flex-column justify-content-between">
            ...
            <div class="asset-header-right"></div>
            ...
            <section class="asset-dapatkan-aplikasi mb-4">
                <div class="asset-dapatkan-aplikasi-content d-flex justify-content-between align-items-center">
                    ...
                    <div class="link-google-and-app-store w-auto d-flex flex-wrap align-items-center">
                        ...
                        <a href="https://itunes.apple.com/app/arts-culture/id1050970557?pt=9008&amp;ct=stella-asset&amp;mt=8" target="_blank" rel="noopener" role="button" aria-label="Dapatkan aplikasinya di App Store" data-gacategory="appbadge" data-gaaction="header" data-galabel="ios">
                            <img class="ViTU3b" src="//www.gstatic.com/culturalinstitute/stella/apple-app-store-badge-en.svg">
                        </a>
                    </div>
                </div>
            </section>
